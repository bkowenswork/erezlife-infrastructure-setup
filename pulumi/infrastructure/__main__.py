...
# databaseConfig = s3.create_bucket(rdsConfig)

# CREATE THE EC2 INSTANCES
# ssmProfile = iam.create_ssm_role()
# instances = utils.read_config("./files/instances.yaml")
# ec2.build_instances(instances, awseast1, 'ami-079db87dc4c10ac91', 'us-east-1', ssmProfile, usSubnet, usGroupIds)
# ec2.build_instances(instances, cacentral1, 'ami-0fe6c9864169f4e41', 'ca-central-1')
